...
class ComponentHandler:
    async def _getVideoComponent(self, element: dict, shelfTitle: str = None) -> dict:
        ...
        component = {
            ...
            'richThumbnail': await self._getValue(video,
            ...
            'channel': {
                ...
                'id': await self._getValue(video, ['ownerText', 'runs', 0, 'navigationEndpoint', 'browseEndpoint',
                                                   'browseId']),
                'thumbnails': await self._getValue(video, ['channelThumbnailSupportedRenderers',
    ...
    async def _getPlaylistComponent(self, element: dict) -> dict:
        ...
        component = {
            ...
            'channel': {
                ...
                'id': await self._getValue(playlist,
                                           ['shortBylineText', 'runs', 0, 'navigationEndpoint', 'browseEndpoint',
                                            'browseId']),
            },
            'thumbnails': await self._getValue(playlist,
