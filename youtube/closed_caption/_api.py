...
from youtube.closed_caption._transcripts import TranscriptListFetcher
...
class YouTubeClosedCaption(object):
    @classmethod
    def list_transcripts(cls, video_id, proxies=None, cookies=None):
        ...
        `transcript.translate('en')`. Example::
            ...
            transcript_list = YouTubeClosedCaption.get('video_id')
    ...
    def get_transcript(cls, video_id, languages=('en',), proxies=None, cookies=None):
        ...
        Retrieves the transcript for a single video. This is just a shortcut for calling::
            ...
            YouTubeClosedCaption.list_transcripts(video_id, proxies).find_transcript(languages).fetch()
